...
You're part of an elite team of covert operatives, Whiplash and Talon, tasked with a high-stakes mission in the glamorous setting of Monaco.

Your target: Carter Verona, a wealthy car dealership owner suspected of illicit activities.

Your objective: infiltrate his heavily secured estate and retrieve a Lamborghini Aventador containing crucial intelligence.

This isn't just a car theft; it's a test of your Linux skills and problem-solving abilities.

You'll be navigating a virtual environment, using real-world Linux commands to uncover hidden information, analyze security logs, and ultimately, gain access to the target vehicle.
...
Ready up and connect to the lobby to start the Monaco Heist terminal game.

Go To [Monaco Heist Lobby](/floor-00)
